...
document.writeln("");
document.writeln("");document.writeln("<li><input checked hidden type=\'radio\'name=\'type\'id=\'type-mijisou\'value=\'https://cn.bing.com/search?q=\'data-placeholder=\'必应Bing\'><label for=\'type-mijisou\'><span style=\'color:#003daa\'>必应</span></label></li>");
document.writeln("");
...
document.writeln("");
document.writeln("");
document.writeln("<li><input checked hidden type=\'radio\'name=\'type\'id=\'type-ditu\'value=\'https://fanyi.baidu.com/?aldtype=16047#en/zh/\'data-placeholder=\'输入翻译内容\'><label for=\'type-ditu\'><span style=\'color:#003daa\'>百度翻译</span></label></li>");
document.writeln("");
